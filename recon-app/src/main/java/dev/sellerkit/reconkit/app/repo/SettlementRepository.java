...
public interface SettlementRepository extends JpaRepository<Settlement, Long> {
    ...
    Optional<Settlement> findByCounterpartyIdAndPeriodStartAndPeriodEnd(
            Long counterpartyId, LocalDate periodStart, LocalDate periodEnd);

    List<Settlement> findAllByOrderByPeriodEndDescIdDesc();
}
