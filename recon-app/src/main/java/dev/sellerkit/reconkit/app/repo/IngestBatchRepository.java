...
public interface IngestBatchRepository extends JpaRepository<IngestBatch, Long> {
    ...
    Optional<IngestBatch> findByCounterpartyIdAndContentHash(Long counterpartyId, String contentHash);

    List<IngestBatch> findTop50ByOrderByIdDesc();

    List<IngestBatch> findByCounterpartyIdAndBusinessDateOrderByIdDesc(Long counterpartyId, LocalDate date);
}
